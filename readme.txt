...
The HeadCounters WordPress plugin adds a widget that displays how many visitors are on your site at that moment. Now Configurable!
...
1. an example of graphic counter: graphic.png
2. an example of text-by counter: text_based.png
